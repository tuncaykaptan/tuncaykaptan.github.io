...
function oyna(oynanan_at){
    ...
    setTimeout("sifirlabutonu()",4500)
    
    var kazanan=random(1,4);
    
    var randomhiz=random(6000,10000);
    var randomhiz2=random(6000,10000);
    if(kazanan==1){
    ...
    document.getElementById(kazananId).style.transition="5000ms all"

    document.getElementById("at1").style.marginLeft="168px";
    document.getElementById("at2").style.marginLeft="168px";
    document.getElementById("at3").style.marginLeft="168px";
